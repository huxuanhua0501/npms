...
public class AuditPmsUser{
    ...
    @ExcelColumn(value = "作废标识", order = 33)
    private String trashFlag;//作废标识

    @ExcelColumn(value = "第一学位", order = 34)
    private String firstDegree;//第一学位

    @ExcelColumn(value = "岗位", order = 35)
    private String station;//岗位

    @ExcelColumn(value = "承担的工作", order = 36)
    private String takeWork;//承担的工作

    @ExcelColumn(value = "研究领域细分", order = 37)
    private String researchFieldDetail;//研究领域细分

    @ExcelColumn(value = "在职学位", order = 38)
    private String jobDegree;//在职学位

    @ExcelColumn(value = "status", order = 39)
    private Integer status;//status

    @ExcelColumn(value = "itemId", order = 40)
    ...
    private Integer hasDiff;//有不同1有0无
