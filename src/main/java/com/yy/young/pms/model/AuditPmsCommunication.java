...
*/
public class AuditPmsCommunication{
    ...
    @ExcelColumn(value = "联系人一名字", order = 12)
    private String nameOne;//联系人一名字

    @ExcelColumn(value = "联系人二名字", order = 13)
    private String nameTwo;//联系人二名字

    @ExcelColumn(value = "1审核2不审核", order = 14)
    private Integer status;//1审核2不审核

    @ExcelColumn(value = "itemId", order = 15)
    private String itemId;//itemId

    public AuditPmsCommunication(){
        super();
    }
