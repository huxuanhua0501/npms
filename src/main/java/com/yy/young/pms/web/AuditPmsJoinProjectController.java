...
*/
@Controller
@RequestMapping("/pms/auditPmsJoinProject")
public class AuditPmsJoinProjectController {

    @Resource(name="auditPmsJoinProjectService")
    IAuditPmsJoinProjectService service;
    ...
    ICommonService<JoinProject> joinProjectService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        List<AuditPmsJoinProject> list = service.getList(obj);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        List<JoinProject> educationList = joinProjectService.getList(null);
        for (JoinProject item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsJoinProject> list = service.getPage(obj, page);
        page.setData(list);
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsJoinProject obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);
            //obj.setLockStatus(1);
            service.insert(obj);//新改
            joinProjectService.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_join_project");
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        joinProjectService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsJoinProject obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            JoinProject work = new JoinProject();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (joinProjectService.get(work) != null) {
                obj.setStatus(1);
                //obj.setLockStatus(1);
                joinProjectService.update(obj.toAnother());
            }else {
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                if (joinProjectService.get(obj.toAnother()) != null) {
                    joinProjectService.update(obj.toAnother());
                }else {
                    joinProjectService.insert(obj.toAnother());
                }
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            joinProjectService.delete(idArr);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsJoinProject> list = ei.getImportDataAsBean(AuditPmsJoinProject.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsJoinProject obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsJoinProject> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsJoinProject.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            String[] idArr = ids.split(",");
            List<AuditPmsJoinProject> list = new ArrayList<AuditPmsJoinProject>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsJoinProject relations = new AuditPmsJoinProject();
