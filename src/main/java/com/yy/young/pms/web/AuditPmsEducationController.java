...
*/
@Controller
@RequestMapping("/pms/auditPmsEducation")
public class AuditPmsEducationController {

    @Resource(name="auditPmsEducationService")
    IAuditPmsEducationService service;
    ...
    ICommonService<Education> educationService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
        List<AuditPmsEducation> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsEducation> list = service.getPage(obj, page);
        page.setData(list);
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsEducation obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
...
//            obj.setLockStatus(1);
            service.insert(obj);
            educationService.insert(obj.toAnother());//TODO,插入顺序有要求
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_education");
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                educationService.insert(obj.toAnother());
            }else {
                obj.setStatus(5);
                service.insert(obj);
                educationService.insert(obj.toAnother());
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        educationService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            Education work = new Education();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (educationService.get(work) != null) {
                obj.setStatus(1);
//                obj.setLockStatus(1);
                educationService.update(obj.toAnother());
            }else {
...
//            service.delete(obj.getId());//审核库有出现脏数据，不需要审，管理员还在审核
                ...
                if (educationService.get(obj.toAnother()) != null) {
                    educationService.update(obj.toAnother());
                }else {
                    educationService.insert(obj.toAnother());
                }
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
        List<Education> educationList = educationService.getList(null);
    ...
    @ResponseBody
    public Object getModuleList(AuditPmsEducation obj, HttpServletRequest request) throws Exception{
...
//        service.getList();
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            educationService.delete(idArr);//新改：删除正式库同时删除审核库
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            educationService.delete(id);//新改：删除正式库同时删除审核库
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsEducation> list = ei.getImportDataAsBean(AuditPmsEducation.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsEducation obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsEducation> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsEducation.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            String[] idArr = ids.split(",");
            List<AuditPmsEducation> list = new ArrayList<AuditPmsEducation>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsEducation relations = new AuditPmsEducation();
    ...
    @ResponseBody
    public Object rsBatchUpdate(@RequestBody List<AuditPmsEducation> list, HttpServletRequest request) throws Exception{
        Result result = new Result();
        service.batchUpdate(list);
        return result;
    }
    ...
    @ResponseBody
    public Object rsBatchInsert(@RequestBody List<AuditPmsEducation> list, HttpServletRequest request) throws Exception{
        Result result = new Result();
