...
*/
@Controller
@RequestMapping("/pms/auditPmsSupportProject")
public class AuditPmsSupportProjectController {

    @Resource(name="auditPmsSupportProjectService")
    IAuditPmsSupportProjectService service;
    ...
    ICommonService<PmsSupportProject> pmsSupportProjectService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        List<AuditPmsSupportProject> list = service.getList(obj);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        List<PmsSupportProject> educationList = pmsSupportProjectService.getList(null);
        for (PmsSupportProject item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsSupportProject> list = service.getPage(obj, page);
        page.setData(list);
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsSupportProject obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);//新增：不需要审核直接通过，两张表都插入
            //obj.setLockStatus(1);
            service.insert(obj);
            pmsSupportProjectService.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_support_project");
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        pmsSupportProjectService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsSupportProject obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            PmsSupportProject work = new PmsSupportProject();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (pmsSupportProjectService.get(work) != null) {
                obj.setStatus(1);
                //obj.setLockStatus(1);
                pmsSupportProjectService.update(obj.toAnother());
            }else {
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                if (pmsSupportProjectService.get(obj.toAnother()) != null) {
                    pmsSupportProjectService.update(obj.toAnother());
                }else {
                    pmsSupportProjectService.insert(obj.toAnother());
                }
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            pmsSupportProjectService.delete(idArr);
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            pmsSupportProjectService.delete(id);
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsSupportProject> list = ei.getImportDataAsBean(AuditPmsSupportProject.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsSupportProject obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsSupportProject> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsSupportProject.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            String[] idArr = ids.split(",");
            List<AuditPmsSupportProject> list = new ArrayList<AuditPmsSupportProject>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsSupportProject relations = new AuditPmsSupportProject();
