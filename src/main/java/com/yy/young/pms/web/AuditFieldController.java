...
public class AuditFieldController {
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditField obj, HttpServletRequest request) throws Exception{
        List<AuditField> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditField obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditField> list = service.getPage(obj, page);
        page.setData(list);
        return page;
    }
    ...
    */
    ...
    @RequestMapping("/get")
    @ResponseBody
    public Object get(AuditField id, HttpServletRequest request) throws Exception{
        AuditField obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditField obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditField obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditField obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        return new Result();
    }
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditField> list = ei.getImportDataAsBean(AuditField.class);
    ...
    */
    ...
    public void exportExcel(AuditField obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditField> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditField.class);
