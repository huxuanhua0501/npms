 ...
 */
@Controller
@RequestMapping("/pms/joinProject")
public class JoinProjectController extends AbstractCommonController<JoinProject> {
    ...
    public void initService() {
        this.service = SpringContextHolder.getBean("joinProjectService");
    }
     ...
     */
    @Override
    public ICommonService<JoinProject> getServiceFromRequest(HttpServletRequest httpServletRequest) {
        return null;
    }
     ...
     */
    @Override
    public JoinProject backFinalParameter(JoinProject joinProject, HttpServletRequest httpServletRequest) {
        return joinProject;
    }
