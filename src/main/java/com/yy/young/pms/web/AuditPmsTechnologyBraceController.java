...
*/
@Controller
@RequestMapping("/pms/auditPmsTechnologyBrace")
public class AuditPmsTechnologyBraceController {

    @Resource(name="auditPmsTechnologyBraceService")
    IAuditPmsTechnologyBraceService service;
    ...
    ICommonService<TechnologyBrace> technologyBraceService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        List<AuditPmsTechnologyBrace> list = service.getList(obj);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        List<TechnologyBrace> educationList = technologyBraceService.getList(null);
        for (TechnologyBrace item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsTechnologyBrace> list = service.getPage(obj, page);
        page.setData(list);
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsTechnologyBrace obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);//新增：不需要审核直接通过，两张表都插入
            //obj.setLockStatus(1);
            service.insert(obj);
            technologyBraceService.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_technology_brace");
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        System.out.println("锁定状态更新：" + obj.getLockStatus() + "  ID："  + obj.getId());
        service.update(obj);
        technologyBraceService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsTechnologyBrace obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            TechnologyBrace work = new TechnologyBrace();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (technologyBraceService.get(work) != null) {
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                if (technologyBraceService.get(obj.toAnother()) != null) {
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            technologyBraceService.delete(idArr);
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            technologyBraceService.delete(id);
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsTechnologyBrace> list = ei.getImportDataAsBean(AuditPmsTechnologyBrace.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsTechnologyBrace obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsTechnologyBrace> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsTechnologyBrace.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            List<AuditPmsTechnologyBrace> list = new ArrayList<AuditPmsTechnologyBrace>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsTechnologyBrace relations = new AuditPmsTechnologyBrace();
