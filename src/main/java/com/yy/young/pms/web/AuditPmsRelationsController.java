...
*/
@Controller
@RequestMapping("/pms/auditPmsRelations")
public class AuditPmsRelationsController {

    @Resource(name="auditPmsRelationsService")
    IAuditPmsRelationsService service;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
        List<AuditPmsRelations> list = service.getList(obj);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
        List<Relation> educationList = oldservice.getList(null);
        for (Relation item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsRelations> list = service.getPage(obj, page);
        page.setData(list);
        ...
        if (obj != null) {
            ...
            if (userId != null) {
                ...
                //outer
                System.out.println("新版最后为：" + AuditShowUser.getPersonalShow());
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsRelations obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
        return new Result();
    }
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsRelations obj, HttpServletRequest request) throws Exception{

        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);//新增：不需要审核直接通过，两张表都插入
//            obj.setLockStatus(1);//管理员添加，直接锁定
            service.insert(obj);
            oldservice.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_relations");
            //判断是否需要随意填 是start
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        oldservice.update(obj.toAnother());
        return new Result();
    }
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            List<AuditPmsRelations> list = new ArrayList<AuditPmsRelations>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsRelations relations = new AuditPmsRelations();
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsRelations obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            Relation work = new Relation();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (oldservice.getList(work).size() > 0) {
                obj.setStatus(1);
//                obj.setLockStatus(1);
                oldservice.update(obj.toAnother());
            }else {
...
//                obj.setLockStatus(1);
            ...
            if (service.getList(work.toAnother()).size() > 0) {
                obj.setStatus(1);
//                obj.setLockStatus(1);
                service.update(obj);
            }else {
...
//            service.delete(obj.getId());//审核库有出现脏数据，不需要审，管理员还在审核
                ...
                //新增start
                if (oldservice.get(obj.getId()) != null) {
                    oldservice.update(obj.toAnother());
                }else {
                    oldservice.insert(obj.toAnother());
                }
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsRelations> list = ei.getImportDataAsBean(AuditPmsRelations.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsRelations obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsRelations> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsRelations.class);
