...
*/
@Controller
@RequestMapping("/pms/showUser")
public class ShowUserController {

    @Resource(name="showUserService")
    IShowUserService service;
    ...
    */
    ...
    @ResponseBody
    public Object getList(ShowUser obj, HttpServletRequest request) throws Exception{
        List<ShowUser> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(ShowUser obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<ShowUser> list = service.getPage(obj, page);
        page.setData(list);
        return page;
    }
    ...
    */
    ...
    @ResponseBody
    public Object count(ShowUser obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(ShowUser obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(ShowUser obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        return new Result();
    }
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<ShowUser> list = ei.getImportDataAsBean(ShowUser.class);
    ...
    */
    ...
    public void exportExcel(ShowUser obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<ShowUser> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, ShowUser.class);
