...
*/
@Controller
@RequestMapping("/pms/auditPmsDept")
public class AuditPmsDeptController {

    @Resource(name="auditPmsDeptService")
    IAuditPmsDeptService service;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsDept obj, HttpServletRequest request) throws Exception{
        List<AuditPmsDept> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsDept obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsDept> list = service.getPage(obj, page);
        page.setData(list);
        return page;
    }
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsDept obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsDept obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsDept obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsDept obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        return new Result();
    }
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsDept> list = ei.getImportDataAsBean(AuditPmsDept.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsDept obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsDept> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsDept.class);
