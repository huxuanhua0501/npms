...
*/
@Controller
@RequestMapping("/pms/pmsCollectEdu")
public class PmsCollectEduController {

    @Resource(name="pmsCollectEduService")
    IPmsCollectEduService service;
    ...
    */
    ...
    @ResponseBody
    public Object getList(PmsCollectEdu obj, HttpServletRequest request) throws Exception{
        List<PmsCollectEdu> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(PmsCollectEdu obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<PmsCollectEdu> list = service.getPage(obj, page);
        page.setData(list);
        return page;
    }
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        PmsCollectEdu obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(PmsCollectEdu obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(PmsCollectEdu obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(PmsCollectEdu obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        return new Result();
    }
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<PmsCollectEdu> list = ei.getImportDataAsBean(PmsCollectEdu.class);
    ...
    */
    ...
    public void exportExcel(PmsCollectEdu obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<PmsCollectEdu> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, PmsCollectEdu.class);
