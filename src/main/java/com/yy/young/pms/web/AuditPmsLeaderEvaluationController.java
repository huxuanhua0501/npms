...
*/
@Controller
@RequestMapping("/pms/auditPmsLeaderEvaluation")
public class AuditPmsLeaderEvaluationController {

    @Resource(name="auditPmsLeaderEvaluationService")
    IAuditPmsLeaderEvaluationService service;
    ...
    ICommonService<PmsLeaderEvaluation> pmsLeaderEvaluationService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
        List<AuditPmsLeaderEvaluation> list = service.getList(obj);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
        List<PmsLeaderEvaluation> educationList = pmsLeaderEvaluationService.getList(null);
        for (PmsLeaderEvaluation item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsLeaderEvaluation> list = service.getPage(obj, page);
        page.setData(list);
        return page;
    }
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsLeaderEvaluation obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{

        AuditField AuditField = new AuditField();
        AuditField.setTableName("pms_leader_evaluation");

        //判断是否需要随意填 是start
        if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
            System.out.println("该表不需要审核");
            obj.setStatus(1);
            service.insert(obj);//新改
            pmsLeaderEvaluationService.insert(obj.toAnother());
        }else {
            obj.setStatus(5);
            service.insert(obj);
            pmsLeaderEvaluationService.insert(obj.toAnother());
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
        System.out.println("锁定状态更新：" + obj.getLockStatus() + "  ID："  + obj.getId());
        service.update(obj);
        pmsLeaderEvaluationService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsLeaderEvaluation obj, HttpServletRequest request) throws Exception{
        ...
        if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
            System.out.println("该表不需要审核");
            PmsLeaderEvaluation work = new PmsLeaderEvaluation();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (pmsLeaderEvaluationService.get(work) != null) {
            ...
            if (pmsLeaderEvaluationService.get(obj.toAnother()) != null) {
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            pmsLeaderEvaluationService.delete(idArr);
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            pmsLeaderEvaluationService.delete(id);
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsLeaderEvaluation> list = ei.getImportDataAsBean(AuditPmsLeaderEvaluation.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsLeaderEvaluation obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsLeaderEvaluation> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsLeaderEvaluation.class);
    ...
    public Object batchUpdate(String ids, int status, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            String[] idArr = ids.split(",");
            List<AuditPmsLeaderEvaluation> list = new ArrayList<AuditPmsLeaderEvaluation>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsLeaderEvaluation relations = new AuditPmsLeaderEvaluation();
