 ...
 */
@Controller
@RequestMapping("/pms/patent")
public class PatentController extends AbstractCommonController<Patent> {
    ...
    public void initService() {
        this.service = SpringContextHolder.getBean("patentService");
    }
     ...
     */
    @Override
    public ICommonService<Patent> getServiceFromRequest(HttpServletRequest httpServletRequest) {
        return null;
    }
     ...
     */
    @Override
    public Patent backFinalParameter(Patent patent, HttpServletRequest httpServletRequest) {
        return patent;
    }
