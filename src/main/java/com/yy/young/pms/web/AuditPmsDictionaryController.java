...
*/
@Controller
@RequestMapping("/pms/auditPmsDictionary")
public class AuditPmsDictionaryController {

    @Resource(name="auditPmsDictionaryService")
    IAuditPmsDictionaryService service;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsDictionary obj, HttpServletRequest request) throws Exception{
        List<AuditPmsDictionary> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsDictionary obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsDictionary> list = service.getPage(obj, page);
        page.setData(list);
        return page;
    }
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsDictionary obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsDictionary obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsDictionary obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsDictionary obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        return new Result();
    }
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsDictionary> list = ei.getImportDataAsBean(AuditPmsDictionary.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsDictionary obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsDictionary> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsDictionary.class);
