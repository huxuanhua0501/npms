...
*/
@Controller
@RequestMapping("/pms/auditPmsMainTechGroup")
public class AuditPmsMainTechGroupController {

    @Resource(name="auditPmsMainTechGroupService")
    IAuditPmsMainTechGroupService service;
    ...
    ICommonService<PmsMainTechGroup> pmsMainTechGroupService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        List<AuditPmsMainTechGroup> list = service.getList(obj);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        List<PmsMainTechGroup> educationList = pmsMainTechGroupService.getList(null);
        for (PmsMainTechGroup item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsMainTechGroup> list = service.getPage(obj, page);
        page.setData(list);
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsMainTechGroup obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);
//            obj.setLockStatus(1);
            service.insert(obj);//新改
            pmsMainTechGroupService.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_main_tech_group");
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                obj.setStatus(5);
                service.insert(obj);
                pmsMainTechGroupService.insert(obj.toAnother());//新改
            }
        }
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        pmsMainTechGroupService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsMainTechGroup obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            PmsMainTechGroup work = new PmsMainTechGroup();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (pmsMainTechGroupService.get(work) != null) {
                obj.setStatus(1);
//                obj.setLockStatus(1);
                pmsMainTechGroupService.update(obj.toAnother());
            }else {
...
//                obj.setLockStatus(1);
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                if (pmsMainTechGroupService.get(obj.toAnother()) != null) {
                    pmsMainTechGroupService.update(obj.toAnother());
                }else {
                    pmsMainTechGroupService.insert(obj.toAnother());
                }
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            pmsMainTechGroupService.delete(idArr);//新改：两个库都删除
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            pmsMainTechGroupService.delete(id);//新改：两个库都删除
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsMainTechGroup> list = ei.getImportDataAsBean(AuditPmsMainTechGroup.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsMainTechGroup obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsMainTechGroup> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsMainTechGroup.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            String[] idArr = ids.split(",");
            List<AuditPmsMainTechGroup> list = new ArrayList<AuditPmsMainTechGroup>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsMainTechGroup relations = new AuditPmsMainTechGroup();
