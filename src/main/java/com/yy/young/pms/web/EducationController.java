 ...
 */
@Controller
@RequestMapping("/pms/education")
public class EducationController extends AbstractCommonController<Education> {
    ...
    public void initService() {
        this.service = SpringContextHolder.getBean("educationService");
    }
     ...
     */
    @Override
    public ICommonService<Education> getServiceFromRequest(HttpServletRequest httpServletRequest) {
        return null;
    }
     ...
     */
    @Override
    public Education backFinalParameter(Education education, HttpServletRequest httpServletRequest) {
        return education;
    }
