...
*/
@Controller
@RequestMapping("/pms/auditPmsTechAwards")
public class AuditPmsTechAwardsController {

    @Resource(name="auditPmsTechAwardsService")
    IAuditPmsTechAwardsService service;
    ...
    ICommonService<PmsTechAwards> pmsTechAwardsService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        List<AuditPmsTechAwards> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsTechAwards> list = service.getPage(obj, page);
        page.setData(list);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        List<PmsTechAwards> educationList = pmsTechAwardsService.getList(null);
        for (PmsTechAwards item : educationList) {
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsTechAwards obj = service.get(id);
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);//新增：不需要审核直接通过，两张表都插入
            //obj.setLockStatus(1);
            service.insert(obj);
            pmsTechAwardsService.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_tech_awards");
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        System.out.println("锁定状态更新：" + obj.getLockStatus() + "  ID："  + obj.getId());
        service.update(obj);
        pmsTechAwardsService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsTechAwards obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            PmsTechAwards work = new PmsTechAwards();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (pmsTechAwardsService.get(work) != null) {
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                if (pmsTechAwardsService.get(obj.toAnother()) != null) {
                    System.out.println("工作修改条目存在");
                    pmsTechAwardsService.update(obj.toAnother());
                }else {
                    System.out.println("工作修改条目不存在");
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            pmsTechAwardsService.delete(idArr);
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            pmsTechAwardsService.delete(id);
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsTechAwards> list = ei.getImportDataAsBean(AuditPmsTechAwards.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsTechAwards obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsTechAwards> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsTechAwards.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            List<AuditPmsTechAwards> list = new ArrayList<AuditPmsTechAwards>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsTechAwards relations = new AuditPmsTechAwards();
