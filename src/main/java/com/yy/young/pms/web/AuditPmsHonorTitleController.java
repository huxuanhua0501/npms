...
*/
@Controller
@RequestMapping("/pms/auditPmsHonorTitle")
public class AuditPmsHonorTitleController {

    @Resource(name="auditPmsHonorTitleService")
    IAuditPmsHonorTitleService service;
    ...
    ICommonService<PmsHonorTitle> pmsHonorTitleService;
    ...
    */
    ...
    @ResponseBody
    public Object getList(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        List<AuditPmsHonorTitle> list = service.getList(obj);
    ...
    */
    ...
    @ResponseBody
    public Object getPage(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        Page page = CommonUtil.getPageFromRequest(request);
        List<AuditPmsHonorTitle> list = service.getPage(obj, page);
        page.setData(list);
    ...
    */
    ...
    public Object get(String id, HttpServletRequest request) throws Exception{
        AuditPmsHonorTitle obj = service.get(id);
    ...
    @ResponseBody
    public Object oldToAudit(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        List<PmsHonorTitle> educationList = pmsHonorTitleService.getList(null);
        for (PmsHonorTitle item : educationList) {
    ...
    */
    ...
    @ResponseBody
    public Object count(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
    ...
    */
    ...
    @ResponseBody
    public Object insert(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        service.insert(obj);
    ...
    @ResponseBody
    public Object auditInsert(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            obj.setStatus(1);//新增：不需要审核直接通过，两张表都插入
            //obj.setLockStatus(1);
            service.insert(obj);
            pmsHonorTitleService.insert(obj.toAnother());
        }else {
            AuditField AuditField = new AuditField();
            AuditField.setTableName("pms_honor_title");
    ...
    @ResponseBody
    public Object lockUpdate(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        service.update(obj);
        pmsHonorTitleService.update(obj.toAnother());
        return new Result();
    }
    ...
    */
    ...
    @ResponseBody
    public Object update(AuditPmsHonorTitle obj, HttpServletRequest request) throws Exception{
        String rs = request.getParameter("sf");
        if (("rs").equals(rs)) {
            PmsHonorTitle work = new PmsHonorTitle();
            work.setUserId(obj.getUserId());
            work.setId(obj.getId());
            if (pmsHonorTitleService.get(work) != null) {
                obj.setStatus(1);
//                obj.setLockStatus(1);
                pmsHonorTitleService.update(obj.toAnother());
            }else {
            ...
            if (auditFieldService.get(AuditField) == null || auditFieldService.get(AuditField).getStatus() != 1) {
                ...
                if (pmsHonorTitleService.get(obj.toAnother()) != null) {
                    pmsHonorTitleService.update(obj.toAnother());
                }else {
                    pmsHonorTitleService.insert(obj.toAnother());
                }
    ...
    */
    ...
    public Object delete(String ids, String id, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            ...
            pmsHonorTitleService.delete(idArr);//新改：删除正式库同时删除审核库
        }else if(StringUtils.isNotBlank(id)){
            service.delete(id);
            pmsHonorTitleService.delete(id);//新改：删除正式库同时删除审核库
        }else{
            result.setCode(-1);
    ...
    public Object importExcel(MultipartFile file, HttpServletRequest request) throws Exception{
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                //从excel读取数据
                List<AuditPmsHonorTitle> list = ei.getImportDataAsBean(AuditPmsHonorTitle.class);
    ...
    */
    ...
    public void exportExcel(AuditPmsHonorTitle obj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<AuditPmsHonorTitle> list = service.getList(obj);
        if (list != null && list.size() > 0){
            IExcelExport ee = new ExcelExport();
            ee.insertBeanList(list, AuditPmsHonorTitle.class);
    ...
    public Object lockBatchUpdate(String ids,int lockStatus, HttpServletRequest request) throws Exception{
        ...
        if(StringUtils.isNotBlank(ids)) {
            String[] idArr = ids.split(",");
            List<AuditPmsHonorTitle> list = new ArrayList<AuditPmsHonorTitle>();
            for (int i = 0; i < idArr.length;i++) {
                AuditPmsHonorTitle relations = new AuditPmsHonorTitle();
