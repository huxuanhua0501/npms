...
<head>
        ...
        <script type="text/javascript">
            $(function(){
                var jParams = {
                    ...
                    "updateUrl" : "pms/auditPmsUser/update.action",//修改添加到新库
    ...
    <style>
        ...
        .dept_ul>li{
            ...
            padding: 0px 12px 0px 12px;background-color: #F7F7F7;cursor: default;
                ...
                <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" style="margin-bottom: 5px;">
                    <tr>
                        ...
                        <td class="tnt">
                            ...
                            <input type="hidden"  name="userId" class="form-control input-sm" readonly ErrEmpty="用户编号不允许为空" />
                            <input type="hidden"  name="id" class="form-control input-sm" readonly ErrEmpty="用户编号不允许为空" />
