...
<%--                    <div class="layui-inline">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="select-content">
                            <ul id="selectContent">
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/personal/selfBaseInfoForm.jsp?edit=true&id=">
                           ...
                           <%--             <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;" lay-href="<%=basePath%>page/pms/communicationForm.jsp?edit=true&id=">
                          ...
                          <%--              <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/relationList.jsp?edit=true&userId=">
                         ...
                         <%--               <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/educationList.jsp?edit=true&userId=">
                        ...
                        <%--                <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a  href="javascript:;" lay-href="<%=basePath%>page/pms/workList.jsp?edit=true&userId=">
                        ...
                        <%--                <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a  href="javascript:;" lay-href="<%=basePath%>page/pms/mainTechGroupList.jsp?edit=true&userId=">
                             ...
                             <%--           <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a  href="javascript:;" lay-href="<%=basePath%>page/pms/honorTitleList.jsp?edit=true&userId=">
                           ...
                           <%--             <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/techAwardsList.jsp?edit=true&userId=">
                         ...
                         <%--               <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a  href="javascript:;" lay-href="<%=basePath%>page/pms/paperList.jsp?edit=true&userId=">
                              ...
                              <%--          <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/publishList.jsp?edit=true&userId=">
                       ...
                       <%--                 <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/patentList.jsp?edit=true&userId=">
                  ...
                  <%--                      <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a  href="javascript:;" lay-href="<%=basePath%>page/pms/joinProjectList.jsp?edit=true&userId=">
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/tnBraceList.jsp?edit=true&userId=">
                     ...
                     <%--                   <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/supportProjectList.jsp?edit=true&userId=">
                  ...
                  <%--                      <span class="txt">完善度</span>
                                ...
                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/yearCheckList.jsp?edit=true&userId=">
...
<%--                                <li>
                                    <a href="javascript:;"  lay-href="<%=basePath%>page/pms/selfEvaluationForm.jsp?edit=true&id=">
 ...
 <%--                               <li>人事处楚楚的<div class="li_close" title="移出此部门">×</div></li>
                ...
                <div class="layui-row row-two">
                    ...
                    <div class="layui-col-md3">
                        ...
                        <div class="col-item edit">
                            <input type="text" name="workStartTime" ErrBirthBad4 disabled required lay-verify="required" placeholder="" autocomplete="off" class="layui-input" id="entry">
                        </div>
                        ...
                        <div class="col-item edit">
                            <input type="text" name="joinPartyTime" ErrBirthBad4 disabled required lay-verify="required" placeholder="" autocomplete="off" class="layui-input" id="rudang">
                        </div>
                ...
                <div class="layui-row row-two">
                    ...
                    <div class="layui-col-md3">
                        ...
                        <div class="col-item edit">
                            <input type="text" name="getTime" disabled ErrBirthBad4 placeholder="" autocomplete="off" class="layui-input" id="get">
                        </div>
                        ...
                        <div class="col-item edit">
                            <input type="text" name="appointmentTime" disabled ErrBirthBad4 placeholder="" autocomplete="off" class="layui-input" id="engage">
                        </div>
                        ...
                        <div class="col-item edit">
                            <input type="text" name="tenureTime" disabled ErrBirthBad4 placeholder="" autocomplete="off" class="layui-input" id="tenureTime">
                        </div>
