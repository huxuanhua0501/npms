...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main" style="">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=URL_STATIC%>page/statistic/pmStatistics.jsp" frameborder="0" data-id="page/portal/home.jsp" seamless></iframe>
        </div>
        <div class="footer">
