    ...
    <script>
        $(function(){
            var jParams = {
                ...
                "addUrl" : "pms/auditPmsMainTechGroup/auditInsert.action",//新增
                "deleteUrl" : "pms/auditPmsMainTechGroup/delete.action",//删除
                "updateUrl" : "pms/auditPmsMainTechGroup/update.action",//修改
                "formDataUrl" : "pms/pmsMainTechGroup/get.action",	//正式库信息
                "auditDataUrl" : "pms/auditPmsMainTechGroup/get.action",//审核库中的信息,列表类此参数其实没用到
            };

            var sf = jo.getDefVal(jo.getUrlParam("sf"),"");
            // if (jo.isValid(sf)) {
                jParams["addUrl"] = "pms/auditPmsMainTechGroup/auditInsert.action?sf=rs";
                jParams["updateUrl"] = "pms/auditPmsMainTechGroup/update.action?sf=rs";
            // }
...
<form id="pageForm" class="layui-form layui-row" action="">
    <div class="edit-item layui-col-md12 layui-col-xs12">
        <label class="layui-form-label sex-label">团体/机构名称</label>
        <div class="layui-input-inline sex-inline lang">
            <input type="text" name="groupName" ErrEmpty placeholder="请填写此项！" autocomplete="off" class="layui-input">
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <input type="text" name="startTime" ErrBirthBad4 placeholder="" autocomplete="off" class="layui-input" id="start">
        </div>
    </div>
    <div class="edit-item layui-col-md6 layui-col-xs6">
    ...
    <div class="edit-item layui-col-md12 layui-col-xs12">
        <label class="layui-form-label">任/兼职务</label>
        <div class="layui-input-inline lang">
            <input type="text" name="post" ErrEmpty placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
