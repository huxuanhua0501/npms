...
<%--    <div class="edit-item layui-col-md6 layui-col-xs6">
    ...
    <div class="edit-item layui-col-md12 layui-col-xs12 ">
        ...
        <div class="layui-input-inline" style="width: calc(100% - 140px);">
            ...
            <textarea class="layui-textarea" name="content" placeholder="格式：起始时间--结束时间 详细内容。例如：2018.09--2019.06 北京大学。说明：时间之间用两个减号分割，内容与时间之间用空格即可" id="content" cols="50" style="height:300px;"></textarea>
        </div>
    </div>
