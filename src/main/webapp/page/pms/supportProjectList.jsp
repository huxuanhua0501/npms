...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">计划/项目名称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="planProjectName" placeholder="" autocomplete="off" class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsSupportProject/getPage.action" deleteUrl="pms/auditPmsSupportProject/delete.action" formUrl="page/pms/supportProjectForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'manpower-training-edit.html?lock=true';
                    } else {
                        url = 'manpower-training-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑人力培养计划/资助项目',
...
/*                $(".add").click(function() {
                    layer.open({ /!*弹出框*!/
                        ...
                        shadeClose: true, //点击遮罩关闭层
                        area: ['650px', '390px'],
                        content: 'manpower-training-add.html'
                    });
                })*/
            });;
        })
