...
<%--                    <div class="layui-inline">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/work/getPage.action" deleteUrl="pms/auditPmsWork/delete.action" formUrl="page/pms/workForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'work-experience-edit.html?lock=true';
                    } else {
                        url = 'work-experience-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑工作经历',
...
/*                $(".add").click(function() {
                    layer.open({ /!*弹出框*!/
                        ...
                        shadeClose: true, //点击遮罩关闭层
                        area: ['650px', '390px'],
                        content: 'work-experience-add.html'
                    });
                })*/
            });;
        })
