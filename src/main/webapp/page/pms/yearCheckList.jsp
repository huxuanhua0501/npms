...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            sfSet();//在初始化表格之前
            joViewInitAboutDoc("430px");//joView初始化处理
        });
        //行处理
...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="years" placeholder="" autocomplete="off" class="layui-input list-input" id="year">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsYearCheck/getPage.action" deleteUrl="pms/auditPmsYearCheck/delete.action" formUrl="page/pms/yearCheckForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'annual-check-edit.html?lock=true';
                    } else {
                        url = 'annual-check-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑年度考核',
