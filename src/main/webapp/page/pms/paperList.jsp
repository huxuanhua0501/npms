...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            sfSet();//在初始化表格之前
            joViewInitAboutDoc("440px");//joView初始化处理
        });
        //行处理
...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="title" placeholder="" autocomplete="off" class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsPaper/getPage.action" deleteUrl="pms/auditPmsPaper/delete.action" formUrl="page/pms/paperForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'the-situation-edit.html?lock=true';
                    } else {
                        url = 'the-situation-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑论文情况',
...
/*                $(".add").click(function() {
                    layer.open({ /!*弹出框*!/
                        ...
                        shadeClose: true, //点击遮罩关闭层
                        area: ['650px', '430px'],
                        content: 'the-situation-add.html'
                    });
                });*/
            });;
        })
