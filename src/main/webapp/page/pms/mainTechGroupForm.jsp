...
<form id="pageForm" class="layui-form layui-row" action="">
    <div class="edit-item layui-col-md12 layui-col-xs12">
        ...
        <div class="layui-input-inline sex-inline lang">
            <input type="text" name="groupName" ErrEmpty placeholder="" autocomplete="off" class="layui-input">
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <input type="text" name="startTime" placeholder="" ErrBirthBad4 autocomplete="off" class="layui-input" id="start">
        </div>
    </div>
    <div class="edit-item layui-col-md6 layui-col-xs6">
