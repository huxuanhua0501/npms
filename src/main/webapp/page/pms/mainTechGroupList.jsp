...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="groupName" placeholder="" autocomplete="off" class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsMainTechGroup/getPage.action" deleteUrl="pms/auditPmsMainTechGroup/delete.action" formUrl="page/pms/mainTechGroupForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'club-experience-edit.html?lock=true';
                    } else {
                        url = 'club-experience-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑社团兼职',
...
/*                $(".add").click(function() {
                    layer.open({ /!*弹出框*!/
                        ...
                        shadeClose: true, //点击遮罩关闭层
                        area: ['650px', '390px'],
                        content: 'club-experience-add.html'
                    });
                })*/
            });;
        })
