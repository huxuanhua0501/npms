...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="achievementsName" placeholder="" autocomplete="off" class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsTechnologyBrace/getPage.action" deleteUrl="pms/auditPmsTechnologyBrace/delete.action" formUrl="page/pms/tnBraceForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'technological-change-edit.html?lock=true';
                    } else {
                        url = 'technological-change-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑技术支撑',
...
/*                $(".add").click(function() {
                    layer.open({ /!*弹出框*!/
                        ...
                        shadeClose: true, //点击遮罩关闭层
                        area: ['650px', '390px'],
                        content: 'technological-change-add.html'
                    });
                })*/
            });;
        })
