...
<head>
    ...
    <script type="text/javascript">
        ...
        joView.handleItem = function(oItem,iIndex){
            oItem._opt = '<a href="javascript:;" class="pass" onclick="joView.auditChangeNoConfirm(1,\'pms/auditPmsMainTechGroup/batchUpdate.action\',\''+oItem.id+'\')">审核通过</a>';
            oItem._opt += '<a href="javascript:;" class="nopass" onclick="joView.auditChangeNoConfirm(2,\'pms/auditPmsMainTechGroup/batchUpdate.action\',\''+oItem.id+'\')">审核不通过</a>';
            oItem._opt += '<a href="javascript:;" class="no-reviewe" onclick="joView.auditChangeNoConfirm(5,\'pms/auditPmsMainTechGroup/batchUpdate.action\',\''+oItem.id+'\')">置为未审核</a>';
        };
            ...
            <div class="person-tit clear" style="padding: 0 0 18px 0;">
                ...
                <div class="layui-form right">
                    <div class="layui-inline button-group">
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary add pass" onclick="joView.auditChange(1,'pms/auditPmsMainTechGroup/batchUpdate.action')">审核通过</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary" style="background: #ff6600;border-color: #ff6600;color: #fff" onclick="joView.auditChange(2,'pms/auditPmsMainTechGroup/batchUpdate.action')">审核不通过</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary change-password no-reviewe" onclick="joView.auditChange(5,'pms/auditPmsMainTechGroup/batchUpdate.action')">置为未审核</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary" style="background: #ff6600;border-color: #ff6600;color: #fff" onclick="joView.changeState(1,'pms/auditPmsMainTechGroup/lockBatchUpdate.action')">锁定条目</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary add pass" onclick="joView.changeState(2,'pms/auditPmsMainTechGroup/lockBatchUpdate.action')">解锁条目</button>
                    </div>

                    <div class="layui-inline">
                        <div class="select clear">
                            <span class="left">6  社团兼职</span>
...
<%--                                <li>
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsMainTechGroup/getPage.action" deleteUrl="pms/auditPmsMainTechGroup/delete.action" formUrl="page/pms/auditMainTechGroupForm.jsp?sf=rs">
                    <col field="groupName" title="团体/机构名称" width="25%" align="left" event="click"/>
                    <col field="post" title="任/兼职务" width="15%" align=""/>
                    <col field="startTime" title="起始时间" width="15%" align=""/>
                    <col field="stopTime" title="结束时间" width="15%" align=""/>
