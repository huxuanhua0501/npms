...
<%--                    <div class="layui-inline">
                    ...
                    <div class="layui-inline">
                        <div class="select clear">
                            ...
                            <%--<span class="baifen right">80%</span>--%>
                        </div>
...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="patentName" placeholder="" autocomplete="off" class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsPatent/getPage.action" deleteUrl="pms/auditPmsPatent/delete.action" formUrl="page/pms/patentForm.jsp">
                    ...
                    <%--<col field="serialNumber" title="序号" width="10%" align=""/>--%>
                </table>
<%--                <div id="pages">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'patent-edit.html?lock=true';
                    } else {
                        url = 'patent-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑专利',
