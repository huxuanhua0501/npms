...
<head>
    ...
    <script type="text/javascript">
        ...
        joView.handleItem = function(oItem,iIndex){
            oItem._opt = '<a href="javascript:;" class="pass" onclick="joView.auditChangeNoConfirm(1,\'pms/auditPmsSupportProject/batchUpdate.action\',\''+oItem.id+'\')">审核通过</a>';
            oItem._opt += '<a href="javascript:;" class="nopass" onclick="joView.auditChangeNoConfirm(2,\'pms/auditPmsSupportProject/batchUpdate.action\',\''+oItem.id+'\')">审核不通过</a>';
            oItem._opt += '<a href="javascript:;" class="no-reviewe" onclick="joView.auditChangeNoConfirm(5,\'pms/auditPmsSupportProject/batchUpdate.action\',\''+oItem.id+'\')">置为未审核</a>';
        };
...
<div class="container">
            ...
            <div class="person-tit clear" style="padding: 0 0 18px 0;">
                ...
                <div class="layui-form right">
                    <div class="layui-inline button-group">
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary add pass" onclick="joView.auditChange(1,'pms/auditPmsSupportProject/batchUpdate.action')">审核通过</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary" style="background: #ff6600;border-color: #ff6600;color: #fff" onclick="joView.auditChange(2,'pms/auditPmsSupportProject/batchUpdate.action')">审核不通过</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary change-password no-reviewe" onclick="joView.auditChange(5,'pms/auditPmsSupportProject/batchUpdate.action')">置为未审核</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary" style="background: #ff6600;border-color: #ff6600;color: #fff" onclick="joView.changeState(1,'pms/auditPmsSupportProject/lockBatchUpdate.action')">锁定条目</button>
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary add pass" onclick="joView.changeState(2,'pms/auditPmsSupportProject/lockBatchUpdate.action')">解锁条目</button>
                    </div>

                    <div class="layui-inline">
                        <div class="select clear">
                            <span class="left">14 人力培养计划/资助项目</span>
 ...
 <%--                               <li>
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsSupportProject/getPage.action" deleteUrl="pms/auditPmsSupportProject/delete.action" formUrl="page/pms/auditSupportProjectForm.jsp?sf=rs">
                    <col field="planProjectName" title="计划/项目名称" width="25%" align="left" event="click"/>
                    <col field="personnelLevel" title="人才层次" width="15%" align=""/>
