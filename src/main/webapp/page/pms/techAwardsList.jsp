...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">获奖项目名称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="awardWinProjectName" placeholder="" autocomplete="off" class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsTechAwards/getPage.action" deleteUrl="pms/auditPmsTechAwards/delete.action" formUrl="page/pms/techAwardsForm.jsp">
...
/*                $(".edit").click(function() {
                    ...
                    if ($(this).parents("tr").find("i").hasClass("icon-suoding")) {
                        url = 'awards-edit.html?lock=true';
                    } else {
                        url = 'awards-edit.html';
                    }
                    layer.open({ /!*弹出框*!/
                        type: 2,
                        title: '编辑获奖情况',
