...
<head>
    ...
    <script>
        ...
        function getCollectData() {
            var result = jo.postAjax("pms/pmsCollectEdu/get",{"id":userId});
        ...
        function saveCollect(sUrl){
            ...
            if (addCollect) {
                sUrl = "pms/pmsCollectEdu/insert";
            }else {
                sUrl = "pms/pmsCollectEdu/update";
            }
            if(jo.isValid(sUrl)){
            ...
            <div class="person-tit clear">
                ...
                <div class="layui-form right">
                    <div class="layui-inline button-group">
                        ...
                        <%--<button id="saveBtn" type="button" class="layui-btn layui-btn-radius layui-btn-primary save" onclick="save()">保存</button>--%>
