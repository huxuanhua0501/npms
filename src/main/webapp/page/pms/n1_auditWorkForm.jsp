...
<form id="pageForm" class="layui-form layui-row" action="">
    <div class="edit-item layui-col-md6 layui-col-xs6">
        <label class="layui-form-label sex-label">工作单位</label>
        <div class="layui-input-inline sex-inline">
            <input type="text" name="workCompany" ErrEmpty  placeholder="" autocomplete="off" class="layui-input" >
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <input type="text" name="workDept"  placeholder="" autocomplete="off" class="layui-input" >
        </div>
    </div>
    <div class="edit-item layui-col-md6 layui-col-xs6">
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <%--<input type="text" name="stopTime"  placeholder="" autocomplete="off" class="layui-input" id="end">--%>
                <input type="text" name="stopTime"  placeholder="格式：2018-08或至今" autocomplete="off" class="layui-input">

        </div>
    </div>
    <div class="edit-item layui-col-md12 layui-col-xs12">
        <label class="layui-form-label">职务职称</label>
