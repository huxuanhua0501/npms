...
<%--                                <li>
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/education/getPage.action" deleteUrl="pms/auditPmsEducation/delete.action" formUrl="page/pms/educationForm.jsp">
...
/*                $(".add").click(function() {
                    layer.open({ /!*弹出框*!/
                        ...
                        shadeClose: true, //点击遮罩关闭层
                        area: ['650px', '390px'],
                        content: 'education-experience-add.html'
                    });
                })*/
            });
        })
