    ...
    <script>
        $(function(){
            var jParams = {
                ...
                "addUrl" : "pms/auditPmsPaper/auditInsert.action",//新增
                "deleteUrl" : "pms/auditPmsPaper/delete.action",//删除
                "updateUrl" : "pms/auditPmsPaper/update.action",//修改
                "formDataUrl" : "pms/paper/get.action",	//正式库信息
                "auditDataUrl" : "pms/auditPmsPaper/get.action"//审核库中的信息,列表类此参数其实没用到
            };

            var sf = jo.getDefVal(jo.getUrlParam("sf"),"");
            // if (jo.isValid(sf)) {
                jParams["addUrl"] = "pms/auditPmsPaper/auditInsert.action?sf=rs";
                jParams["updateUrl"] = "pms/auditPmsPaper/update.action?sf=rs";
            // }
...
<form id="pageForm" class="layui-form layui-row" action="">
    <div class="edit-item layui-col-md12 layui-col-xs12">
        <label class="layui-form-label sex-label">题　　目</label>
        <div class="layui-input-inline sex-inline lang">
            <input type="text" name="title" ErrEmpty placeholder="" autocomplete="off" class="layui-input">
    ...
    <div class="edit-item layui-col-md12 layui-col-xs12">
        ...
        <div class="layui-input-inline lang">
            <input type="text" name="periodicalName" placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        <label class="layui-form-label">卷　　期</label>
        <div class="layui-input-inline">
            <input type="text" name="volume" placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="edit-item layui-col-md6 layui-col-xs6">
        <label class="layui-form-label">页</label>
        <div class="layui-input-inline">
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <input type="text" name="influenceFactor" placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="edit-item layui-col-md6 layui-col-xs6">
        <label class="layui-form-label">他引次数</label>
        <div class="layui-input-inline">
            <input type="text" name="hisCitation" placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="edit-item layui-col-md12 layui-col-xs12">
