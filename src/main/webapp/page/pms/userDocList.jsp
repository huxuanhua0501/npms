...
<head>
    ...
    <script type="text/javascript">
        ...
        joView.edit = function(id,sWidth,sHeight,sTitle){
            ...
            if(typeof(joView.clickItem) == "function"){
                ...
                if(jo.isValid(joView.params["formUrl"])){//有效的表单地址
                    ...
                    // opennew(id);
                    //旧的
                    // top.jo.showWin(joView.params["formUrl"]+jo.getLinkSign(joView.params["formUrl"])+joView.params["PKName"]+'='+(id) +"&sf=rs"+ joView.params["transferParam"],jo.getDefVal(sWidth, joView.params["formWidth"]),jo.getDefVal(sHeight, joView.params["formHeight"]),jo.getDefVal(sTitle, joView.params["winTitleOfUpdate"]), joView.params["winNameOfUpdate"]);
        ...
        //测试新打开弹出层
        function opennew(id) {
            // id=d6ed740de85b437580b3c544a45032b5";//原来userdoc
            var url = "page/personal/myDoc.jsp?sf=rs&id=" + id;
            url = jo.parseUrl(url);
            top.layer.open({ /*弹出框*/
                type: 2,
                title: '人事管理',
    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="pms/pmsUser/getPage.action" deleteUrl="pms/pmsUser/delete.action" formUrl="page/personal/myDoc.jsp?edit=true"><%--page/personal/myDoc.jsp--%>  <%--page/pms/userForm.jsp--%>
