...
<%--                                <li>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <%--<input type="text" name="universityName" placeholder="" autocomplete="off" class="layui-input list-input">--%>
        ...
        <form class="layui-form layui-form-box layui-col-md12 person">
            <div class="person-list-content">
                ...
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsEducation/getPage.action" deleteUrl="pms/auditPmsEducation/delete.action" formUrl="page/pms/educationForm.jsp">
                    <col field="content" title="详细内容" width="15%" align="" event="click"/>
