    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="pms/pmsSelfEvaluation/getPage.action" deleteUrl="pms/pmsSelfEvaluation/delete.action" formUrl="page/pms/pmsSelfEvaluationForm.jsp">
                    <col field="id" title="编号，主键，无意义" width="15%" align="" event="click"/>
                    <col field="userId" title="用户编号" width="15%" align=""/>
                    <col field="selfEvaluation" title="自我评价" width="15%" align=""/>
                </table>
            </div>
            <%--/grid--%>
