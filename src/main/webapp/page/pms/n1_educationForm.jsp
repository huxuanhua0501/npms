...
<form id="pageForm" class="layui-form layui-row" action="">
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <input type="text" name="universityName" ErrEmpty  placeholder="" autocomplete="off" class="layui-input">
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        ...
        <div class="layui-input-inline">
            <input type="text" name="professionalName" ErrEmpty placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="edit-item layui-col-md6 layui-col-xs6">
        <label class="layui-form-label sex-label">学　　历</label>
    ...
    <div class="edit-item layui-col-md6 layui-col-xs6">
        <label class="layui-form-label sex-label">学　　位</label>
        <div class="layui-input-inline sex-inline">
    ...
    <div class="edit-item layui-col-md12 layui-col-xs12">
        ...
        <div class="layui-input-inline lang">
            <input type="text" name="cultureMode"  placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
