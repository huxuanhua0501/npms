    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="pms/pmsLeaderEvaluation/getPage.action" deleteUrl="pms/auditPmsLeaderEvaluation/delete.action" formUrl="page/pms/leaderEvaluationForm.jsp">
