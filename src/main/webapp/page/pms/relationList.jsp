...
<%--                                <li>
            ...
            <div class="person-list-content">
                <table class="layui-table layui-form" id="mainList" dataUrl="pms/auditPmsRelations/getPage.action" deleteUrl="pms/relation/delete.action" formUrl="page/pms/relationForm.jsp">
