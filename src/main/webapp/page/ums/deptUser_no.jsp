            ...
            <div class="person-tit clear" style="padding: 14px;">
                ...
                <div class="layui-form right">
                    <div class="layui-inline button-group">
                        <button type="button" class="layui-btn layui-btn-radius layui-btn-primary reset"
                                onclick="window.location.reload()"><i class="layui-icon layui-icon-refresh"></i> 刷新
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="form-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="USER_NAME" name="name" placeholder="" autocomplete="off"
                               class="layui-input list-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item" style="display:block;">
                    <label class="layui-form-label">员工归属</label>
                    <div class="layui-input-inline type-inline">
                        <select id="noDeptUser" name="noDeptUser" lay-verify="">
                            <option value="1">有部门</option>
                            <option value="2">无部门</option>
                        </select>
                    </div>
...
<script>
    ...
    function loadDeptUser(gotoPage) {
        ...
        var noDeptUser = jo.getDefVal($("#noDeptUser").val(), "");
        var sUrl = 'pms/pmspreview/getDeptUserPage.action';
        jo.postAjax(sUrl, {
            pageNumber: gotoPage, pageSize: 25, USER_NAME: userName, DEPT_ID: deptId,
            STATE: state, SEX: sex, noDeptUser: noDeptUser, ALLUSER: true
        }, function (json) {
            if (json && json.code == "0") {
                if (json.data && json.data[0]) {
                    page = json;
    ...
    function userEdit(userId) {
        top.jo.showWin("page/personal/editDoc.jsp?edit=true&id=" + (userId), "90%", "90%", "员工编辑", "WIN_USER_DOC");
        ...
        //     shadeClose: true, //点击遮罩关闭层
        //     area: ['85%', '85%'],
        //     content: 'page/personal/editDoc.jsp?edit=true&id=' + userId + '&_t=' + (new Date()).getTime(),
        //     end: function () {
        //         loadDeptUser(page.pageNumber);
        //     }
        // });
