...
<head>
    ...
    <title>关于我们</title>
    <link rel="stylesheet" href="<%=URL_STATIC%>static/css/bootstrap.min.css">
    <link rel="stylesheet" href="<%=URL_STATIC%>static/css/style.css">
    <link rel="stylesheet" href="<%=URL_STATIC%>static/css/aboutUs.css">
</head>
...
<body>
    <div class="container-fluid">
        <div class="header clear">
            <div class="left">
                <img src="<%=URL_STATIC%>static/image/logo.jpg" alt="">
