...
(function(){
    ...
    /**
     * 弹窗(iframe),TODO 2018-8-15 新增参数：shadeClose,点击遮罩层关闭
     ...
     */
    jo.showWin = function(sUrl,sWidth,sHeight,sTitle,sWinName,isFull,hasShade,shadeClose){
        var index;
        if(typeof (sUrl) == "object"){
            ...
            if(typeof (shadeClose) == "boolean" && shadeClose){
