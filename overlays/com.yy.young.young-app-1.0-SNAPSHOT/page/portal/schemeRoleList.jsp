        ...
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="form-inline search-bar" id="pageForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="roleId" class="form-control input-sm" value="">
                </div>
                <div class="form-group">
    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="portal/schemeRole/getSchemeRolePage.action" deleteUrl="portal/schemeRole/delete.action" formUrl="page/portal/schemeRoleForm.jsp">
                    ...
                    <col field="roleName" title="角色名称" width="15%" align=""/>
