            ...
            <ul class="nav" id="side-menu">
                ...
                <%--<li>
                    <a href="#">
                        ...
                        <span class="nav-label">页面打开方式</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="index_v1.html" data-index="0">打开右侧索引为0的页面</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="index_v4.html">右侧打开</a>
                        </li>
                        <li>
                            <a href="index_v5.html" target="_blank">打开新页面</a>
                        </li>
                    </ul>

                </li>--%>
                <%--<li>
                    <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">一级带连接菜单</span><span class="label label-warning pull-right">16</span></a>
                </li>
                <li>
                    <a href="#">
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="form_wizard.html">二级菜单</a>
                        </li>
                        <li>
                            <a href="#">带孩子的二级菜单 <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="#"><i class="fa fa-edit"></i><span class="nav-label">三级菜单</span><span class="fa arrow"></span></a>
                                    <ul class="nav nav-fourth-level">
                                        <li>
                                            <a class="J_menuItem" href="form_wizard.html"><i class="fa fa-edit"></i><span class="nav-label">四级菜单1</span><span class="fa arrow"></span></a>
                                            <ul class="nav nav-fifth-level">
                                                <li><a class="J_menuItem" href="form_file_upload.html"><i class="fa fa-edit"></i>5级菜单了</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a class="J_menuItem" href="form_wizard.html">四级菜单2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a class="J_menuItem" href="form_file_upload.html">三级菜单2</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
