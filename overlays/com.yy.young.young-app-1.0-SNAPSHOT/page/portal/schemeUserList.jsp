    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="portal/schemeUser/getSchemeUserPage.action" deleteUrl="portal/schemeUser/delete.action" formUrl="page/portal/schemeUserForm.jsp">
                    <col field="id" title="主键" width="15%" align="" event="click"/>
                    <col field="schemeId" title="方案id" width="15%" align=""/>
