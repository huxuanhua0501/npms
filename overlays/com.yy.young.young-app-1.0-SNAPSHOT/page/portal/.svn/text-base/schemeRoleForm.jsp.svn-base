        ...
        <script type="text/javascript">
            $(function(){
                var jParams = {
                    "PKName" : "id",//主键属性名
                    "saveAfter" : "toEdit",
                    "addUrl" : "portal/schemeRole/insert.action",//新增
                    "deleteUrl" : "portal/schemeRole/delete.action",//删除
                    "updateUrl" : "portal/schemeRole/update.action",//修改
                    "formDataUrl" : "portal/schemeRole/getSchemeRole.action"	//查询
                };
...
<form id="pageForm" name="pageForm" action="" method="post">
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            <td class="active" align="">角色编号</td>
            <td class="tnt">
                <input type="text"  name="roleId" class="form-control input-sm" />
            </td>
        </tr>
        <tr>
            <td class="active" align="">角色名称</td>
            <td class="tnt">
