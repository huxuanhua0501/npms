    ...
    <script type="text/javascript">
        $(function(){
            var jParams = {
                "PKName" : "id",//主键属性名
                "saveAfter" : "toEdit",
                "addUrl" : "portal/schemeUser/insert.action",//新增
                "deleteUrl" : "portal/schemeUser/delete.action",//删除
                "updateUrl" : "portal/schemeUser/update.action",//修改
                "formDataUrl" : "portal/schemeUser/getSchemeUser.action"	//查询
            };
...
<form id="pageForm" name="pageForm" action="" method="post">
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        <tr>
            ...
            <td width="15%" class="active" align="">方案</td>
            <td class="tnt">
