        ...
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="form-inline search-bar" id="pageForm">
                <div class="form-group">
                    <label class="control-label" for="CKEY">KEY&nbsp;</label>
                    <input class="form-control input-sm" id="CKEY" name="CKEY" placeholder="" autocomplete="off" type="text">
                </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="common/platformConfig/getConfigPage.action"
                       deleteUrl="common/platformConfig/deleteConfig.action" formUrl="page/common/platformConfigForm.jsp">
                    <col field="CKEY" title="KEY" width="20%" align="left" event="click"/>
                    <col field="CVALUE" title="VALUE" width="25%" align="left"/>
