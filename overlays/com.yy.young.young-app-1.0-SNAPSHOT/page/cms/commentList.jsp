    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="form-inline search-bar" id="pageForm">
                ...
                <div class="form-group">
                    <label class="control-label">回复编号：&nbsp;</label>
                    <input type="text" name="commentId" class="form-control input-sm" value="">
                </div>
                <div class="form-group">
                    <label class="control-label">主题编号：&nbsp;</label>
                    <input type="text" name="topicId" class="form-control input-sm" value="">
                </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="cms/comment/getPage.action" deleteUrl="cms/comment/delete.action" formUrl="page/cms/commentForm.jsp">
                    <col field="id" title="评论编号" width="15%" align="" event="click"/>
                    <col field="topicId" title="主题编号" width="15%" align=""/>
