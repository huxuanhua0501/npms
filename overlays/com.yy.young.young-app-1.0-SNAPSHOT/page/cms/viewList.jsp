        ...
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="form-inline search-bar" id="pageForm">
                <div class="form-group">
                    <label class="control-label" for="name">视图名&nbsp;</label>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="{URL_CMS}cms/view/getViewPage.action"
                       deleteUrl="{URL_CMS}cms/view/deleteView.action" formUrl="page/cms/viewForm.jsp">
                    <col field="name" title="视图名称" width="20%" align="" event="click"/>
                    <col field="moduleId" title="所属模块" width="15%" align=""/>
                    <col field="[=jo.formatTime('{createTime}')]" title="创建时间" width="20%" align=""/>
