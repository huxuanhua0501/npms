...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            //创建模块树
            cms.createModuleTreeOfButton("moduleTree",function(event,treeId,treeNode){
                if(treeNode.id){
        ...
        <div class="col-xs-12 col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="{URL_CMS}cms/button/getButtonPage.action"
                       deleteUrl="{URL_CMS}cms/button/deleteButton.action" formUrl="page/cms/buttonForm.jsp">
