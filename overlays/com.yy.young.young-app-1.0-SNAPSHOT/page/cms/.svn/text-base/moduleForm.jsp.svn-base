    ...
    <script type="text/javascript">
        $(function(){
            var jParams = {
                "PKName" : "id",//主键
                "saveAfter" : "toEdit",
                "addUrl" : "cms/module/insertModule.action",//新增
                "deleteUrl" : "cms/module/deleteModule.action",//删除
                "updateUrl" : "cms/module/updateModule.action",//修改
                "formDataUrl" : "cms/module/getModuleList.action"	//查询
            };
...
<form id="pageForm" name="pageForm" action="" method="post">
        ...
        <%--<table class="joForm"  cellpadding="3" cellspacing="0">--%>
            <tr>
                ...
                <td width="15%" class="active must">模块名称</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="createUser" <%--onclick="laydate()"--%> readonly class="form-control input-sm">
                </td>
            </tr>
            <tr>
