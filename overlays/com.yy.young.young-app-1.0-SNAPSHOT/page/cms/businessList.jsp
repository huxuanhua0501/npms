    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-condensed" id="mainList" dataUrl="{URL_CMS}cms/business/getBusinessPage.action"
                       deleteUrl="{URL_CMS}cms/business/deleteBusiness.action" formUrl="page/cms/businessForm.jsp">
                    <col field="name" title="业务名称" width="15%" align="" event="click"/>
